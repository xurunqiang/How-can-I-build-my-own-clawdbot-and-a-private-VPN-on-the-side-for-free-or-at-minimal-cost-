...
# 国外：
# 第一种(免费的真不好弄，但是真的香)
1.（先说免费的）想必和多人也知道就是就是注册aws免费送，送一年还是多久去了（白嫖党嘴角都压不住了），我卡在绑银行卡那一步了，无福消受（我直接哭）。
首先，打开亚马逊云服务器官网，完成账号注册 / 登录（aws.amazon.com）
![注册](image/1.png)（就贴图一张算了，github还没用明白，好吧我有点懒不想去截图了）
...
# 2.连接成功后打开https://docs.molt.bot/start/getting-started（可以找到按照指令，我这里也提供）
